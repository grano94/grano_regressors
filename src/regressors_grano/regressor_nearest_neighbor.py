from sklearn.neighbors import KNeighborsRegressor       # nearest neighbor regressor
import numpy as np
...
class KNeigRegressor:
    ...
    def __init__(self, name: str="KNeighbors Regressor"):
        """Instantiates ridge regressor.

        Args:
            name (str, optional): Name tag for regessor. Defaults to "KNeighbors Regressor".
        """
        self.name = name
        self.type = "kn"
